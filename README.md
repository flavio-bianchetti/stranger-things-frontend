...
Este repositório contém o projeto "_Stranger Things - Frontend_", requisito em atendimento ao módulo de Back-end - Deployment, da Trybe. O projeto consiste em configurar um frontend com o Heroku, utilizando o Docker em ambiente de produção.
